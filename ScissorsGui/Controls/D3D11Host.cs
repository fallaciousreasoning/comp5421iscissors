...
namespace ScissorsGui.Controls
{
    /// <summary>
    ...
    public class D3D11Host : Image
    {
        ...
        private static void InitializeGraphicsDevice(int width=800, int height=480)
        {
        ...
        private void OnRendering(object sender, EventArgs eventArgs)
        {
            ...
            totalGameTime += _timer.Elapsed;

            var gameTime = new GameTime(totalGameTime, elapsedTime);
            Update(gameTime);
